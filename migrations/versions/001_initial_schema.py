...
def upgrade() -> None:
    ...
    op.create_table(
        'cart_items',
        sa.Column('cart_item_id', sa.String(64), nullable=False),
    ...
    op.create_table(
        'wishlist_items',
        sa.Column('wishlist_item_id', sa.String(64), nullable=False),
        sa.Column('user_id', sa.String(length=64), nullable=False),
    ...
    op.create_table(
        'banners',
        sa.Column('banner_id', sa.String(64), nullable=False),
        sa.Column('title', sa.String(length=100), nullable=False),
