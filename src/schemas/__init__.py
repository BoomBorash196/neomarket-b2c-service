...
class CategoryItem(BaseModel):
    """A single category item returned by flat list endpoint."""
    category_id: str
    name: str
    parent_id: Optional[str] = None
...
class CategoryListResponse(BaseModel):
    """Response for GET /catalog/categories — flat list of all categories."""
    items: List[CategoryItem]


# --- Home data schema ---
class HomeDataResponse(BaseModel):
    """Response for GET /home — banners + collections in one call."""
    banners: List[Banner]
    collections: List[Collection]
    featured_categories: List[CategoryItem] = []